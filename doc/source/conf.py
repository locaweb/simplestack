...
html_theme_options = {
    ...
    'github_user': 'locaweb',
    'github_repo': 'simplestack',
    'home_url': 'http://simplestack.rtfd.org',
...
htmlhelp_basename = 'Simplestackdoc'
...
latex_documents = [
  ('index', 'Simplestack.tex', u'Simplestack Documentation',
   u'Locaweb team', 'manual'),
]
...
man_pages = [
    ('index', 'simplestack', u'Simplestack Documentation',
     [u'Locaweb team'], 1)
]
...
texinfo_documents = [
  ('index', 'Simplestack', u'Simplestack Documentation',
   u'Locaweb team', 'Simplestack', 'A simple hypervisor control layer'),
]
